    ...
    var body: some View {
        ZStack {
            ...
            ForEach(1..<150, id: \.self) { index in
                ...
                let xPosition = Array(1...Int(UIScreen.main.bounds.width))
                    .randomElement() ?? 0
                let yPosition =
                Array(1...Int(UIScreen.main.bounds.height))
                    .randomElement() ?? 0
                    ...
                    .overlay {
                        ZStack {
                            Circle()
                                ...
                                .frame(width: 60)
                                .position(x: localFrame.midX - 60,
                                          y: localFrame.midY - 60)
                            Circle()
                                .fill(.gray.opacity(0.2))
                                .frame(width: 40)
